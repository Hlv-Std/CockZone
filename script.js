...
function filtraCatalogo2(categoria2) {
  if (categoria2 === "Tutti") return catalogo2;
  return catalogo2.filter((item) => item.categoria2 === categoria2);
}

const contenuto2 = catalogo2.find((item) => item.id === id);
const contenuto2 = catalogo2.find((item) => item.id === id);
